...
import (
	...
	"github.com/kaushik-i-b/flashloanchain/app"
)
...
// genesisCommand builds genesis-related `flashloanchaind genesis` command. Users may provide application specific commands as a parameter
